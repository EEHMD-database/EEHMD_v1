...
void chatterCallback(const ros_eehmd::leapmsgConstPtr& leap_msg )
{
  ...
  ros_eehmd::JointCoordinates joint_coordinates_temp;
...
int main(int argc, char **argv)
{
 ...
 ros::Publisher joint_coordinate_publisher = n.advertise<ros_eehmd::JointCoordinates>("joint_coordinates_from_leap", 1000);
