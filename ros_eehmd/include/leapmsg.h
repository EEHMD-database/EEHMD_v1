// Generated by gencpp from file ros_eehmd/leapmsg.msg
// DO NOT EDIT!


#ifndef ROS_EEHMD_MESSAGE_LEAPMSG_H
#define ROS_EEHMD_MESSAGE_LEAPMSG_H
...
struct leapmsg_
{
  ...
  typedef boost::shared_ptr< ::ros_eehmd::leapmsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ros_eehmd::leapmsg_<ContainerAllocator> const> ConstPtr;

}; // struct leapmsg_

typedef ::ros_eehmd::leapmsg_<std::allocator<void> > leapmsg;

typedef boost::shared_ptr< ::ros_eehmd::leapmsg > leapmsgPtr;
typedef boost::shared_ptr< ::ros_eehmd::leapmsg const> leapmsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ros_eehmd::leapmsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ros_eehmd::leapmsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ros_eehmd::leapmsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_eehmd::leapmsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_eehmd::leapmsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_eehmd::leapmsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_eehmd::leapmsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_eehmd::leapmsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ros_eehmd::leapmsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ff99b88e60716cddb8e2dfc25abd6e56";
  }

  static const char* value(const ::ros_eehmd::leapmsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xff99b88e60716cddULL;
  static const uint64_t static_value2 = 0xb8e2dfc25abd6e56ULL;
};

template<class ContainerAllocator>
struct DataType< ::ros_eehmd::leapmsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ros_eehmd/leapmsg";
  }
...
template<class ContainerAllocator>
struct Definition< ::ros_eehmd::leapmsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ros_eehmd::leapmsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ros_eehmd::leapmsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_eehmd::leapmsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ROS_EEHMD_MESSAGE_LEAPMSG_H
